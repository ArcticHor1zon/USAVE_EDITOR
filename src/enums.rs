...
pub enum UnlockableWeaponVariant {
    ...
    PumpChargeShotgun,
    #[strum(to_string = "Sawed-On Shotgun")]
    SawedOnShotgun,
    #[strum(to_string = "Jackhammer")]
    Jackhammer,
    #[strum(to_string = "Attractor Nailgun")]
    AttractorNailgun,
    #[strum(to_string = "Overheat Nailgun")]
    OverheatNailgun,
    #[strum(to_string = "Jumpstart Nailgun")]
    JumpstartNailgun,
    ...
    #[strum(to_string = "Firestarter Rocket Launcher")]
...
pub enum EnemyType {
    ...
    FleshPanopticon = 30,
    #[strum(to_string = "Mannequin")]
    Mannequin = 31,
    #[strum(to_string = "Gutterman")]
    Gutterman = 32,
    #[strum(to_string = "Guttertank")]
    Guttertank = 33,
    #[strum(to_string = "1000-THR Defence System")]
    ThrDefenceSystem = 34,
    #[strum(to_string = "Earthmover")]
    Earthmover = 35,
    #[strum(to_string = "Big Johninator")]
    BigJohninator = 36,
    #[strum(to_string = "Minotaur")]
    Minotaur = 37,
    #[strum(to_string = "Puppet")]
    Puppet = 38,
    #[strum(to_string = "Providence")]
    Providence = 39,
    #[strum(to_string = "Deathcatcher")]
    Deathcatcher = 40,
    #[strum(to_string = "Mirror Reaper")]
    MirrorReaper = 41,
    #[strum(to_string = "Power")]
    Power = 42,
    #[strum(to_string = "Geryon")]
    Geryon = 43,
}
...
pub enum SecretLevel {
    ...
    WaitOfTheWorld,
    #[strum(to_string = "7-S: HELL BATH NO FURY")]
    HellBathNoFury,
    #[strum(to_string = "8-S: ???")]
    UnknownSecret8,
    UnknownPrime3,
...
impl Layer {
    pub fn get_levels(&self) -> &[Level] {
        match self {
            ...
            Self::Fraud => &[
                Level::HurtbreakWonderland,
                Level::ThroughTheMirror,
                Level::DisintegrationLoop,
                Level::FinalFlight,
            ],
            Self::Treachery => &[],
        }
...
pub enum Level {
    ...
    #[strum(to_string = "8-1: HURTBREAK WONDERLAND")]
    HurtbreakWonderland = 30,
    #[strum(to_string = "8-2: THROUGH THE MIRROR")]
    ThroughTheMirror = 31,
    #[strum(to_string = "8-3: DISINTEGRATION LOOP")]
    DisintegrationLoop = 32,
    #[strum(to_string = "8-4: FINAL FLIGHT")]
    FinalFlight = 33,
...
impl Level {
    ...
    pub fn get_secret_count(&self) -> u8 {
        match self {
            ...
            Self::LikeAntennasToHeaven => 5,
            Self::HurtbreakWonderland => 5,
            Self::ThroughTheMirror => 5,
            Self::DisintegrationLoop => 5,
            Self::FinalFlight => 5,
